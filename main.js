...
const NUM_1 = document.getElementById("home-banner");
...
fetch(BASE_URL + params)
  ...
  .then((data) => {
    ...
    NUM_1.style.background = `url('${data.items[0].snippet.thumbnails.maxres.url}')`;
    NUM_1.style.backgroundRepeat = "no-repeat";
    NUM_1.style.backgroundSize = "cover";
    NUM_1.style.backgroundPosition = "center";
